...
description: >-
  ابزارهای قدرتمند برای حرفه‌ای‌ها: Stash, Cherry-pick, Blame, Diff, Submodules,
  LFS و شخصی‌سازی گیت.
authors: []
order: 5
workshop: git
...
<Callout type="info" title="ابزارهای گرافیکی">
...
<Callout type="danger" title="نکته مهم">
...
<Callout type="info" title="محدودیت‌ها">
