...
description: >-
  در این بخش یاد می‌گیرید که گیت چیست و چه کاربردی دارد. همچنین شروع کار با گیت
  را یاد می‌گیرید.
authors: []
order: 1
workshop: git
...
پس از [نصب GitHub CLI](https://cli.github.com/) متناسب با سیستم‌عامل خود، با دستور زیر به حساب گیت‌هاب خود متصل شوید:
...
### ریپازیتوری چیست؟ <Tooltip tip="Repository"><span>ریپازیتوری</span></Tooltip> مجموعه‌ای از تاریخچه تمام کامیت‌های پروژه از ابتدا تا کنون است. هر ریپازیتوری
شامل نسخه فعلی پروژه و تمام نسخه‌های قبلی آن می‌شود.

### انواع ریپازیتوری

- <Tooltip tip="Local Repository"><span>ریپازیتوری محلی</span></Tooltip>
  : ریپازیتوری روی کامپیوتر شما
- <Tooltip tip="Remote Repository"><span>ریپازیتوری راه‌دور</span></Tooltip>
